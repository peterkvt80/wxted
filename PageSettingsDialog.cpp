...
const wxWindowID PageSettingsDialog::ID_STATICTEXT4 = wxNewId();
const wxWindowID PageSettingsDialog::ID_STATICTEXT5 = wxNewId();
const wxWindowID PageSettingsDialog::ID_STATICTEXT2 = wxNewId();
const wxWindowID PageSettingsDialog::ID_STATICTEXT3 = wxNewId();
const wxWindowID PageSettingsDialog::ID_STATICTEXT1 = wxNewId();
const wxWindowID PageSettingsDialog::ID_TEXTCTRLPAGENUMBER = wxNewId();
const wxWindowID PageSettingsDialog::ID_TEXTCTRLDESCRIPTION = wxNewId();
const wxWindowID PageSettingsDialog::ID_TEXTCTRLCYCLETIME = wxNewId();
